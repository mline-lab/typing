...
function GetCookie() {
    ...
    var cookieName = "yukino_chapter_save" + '=';
...
function SetCookie() {
    ...
    document.cookie = "yukino_chapter_save=" + story_chapter + "; expires=" + expire.toUTCString();
}
...
function stopTyping() {
    ...
    if (bacteri_hp == 0) {
        audioWin.play();
        bgimg.style.backgroundImage = "url(../images/typing/bg/yukino_win.jpg)";
