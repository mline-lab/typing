...
function getCSV_jp_File() {
    if (difficulty_check == 1) {
        ...
        xhr.open("get", "../csv/word_easy.csv", true);
        xhr.send(null);
        xhr.onload = function() {
...
function getCSV_hira_File() {
    if (difficulty_check == 1) {
        ...
        xhr2.open("get", "../csv/word_easy_hiragana.csv", true);
        xhr2.send(null);
...
function on_mute() {
    if (mute == 0) {
        mute_button.src = "../images/volume/volume_off.png";
        audioBad.volume = 0;
        audioBGM.volume = 0;
        audioElem.volume = 0;
        audioAtk1.volume = 0;
        ...
        mute_button.src = "../images/volume/volume_on.png";
        audioBad.volume = 0.3;
        audioBGM.volume = 0.5;
...
function bgm_volume_up() {
    if (bgm_volume != 10) {
        ...
        bgm_volume_button.src = "../images/volume/v" + bgm_volume + ".png";
    }
}
