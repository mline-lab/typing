...
function GetCookie() {
    ...
    var cookieName = "yayoi_chapter_save" + '=';
...
function SetCookie() {
    ...
    document.cookie = "yayoi_chapter_save=" + story_chapter + "; expires=" + expire.toUTCString();
}
...
function stopTyping() {
    ...
    if (bacteri_hp == 0) {
        audioWin.play();
        bgimg.style.backgroundImage = "url(../images/typing/bg/yayoi_win.jpg)";
