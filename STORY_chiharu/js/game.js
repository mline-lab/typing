...
function GetCookie() {
    ...
    var cookieName = "chiharu_chapter_save" + '=';
...
function SetCookie() {
    ...
    document.cookie = "chiharu_chapter_save=" + story_chapter + "; expires=" + expire.toUTCString();
}
...
function stopTyping() {
    ...
    if (bacteri_hp == 0) {
        audioWin.play();
        bgimg.style.backgroundImage = "url(../images/typing/bg/chiharu_win.jpg)";
